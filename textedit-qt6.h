#ifndef TEXTEDIT_QT6__H
#define TEXTEDIT_QT6__H
...
public:
	...
	static QPageSize::PageSizeId pagesize_from_qstring(const QString&);
	static QString qstring_from_pagesize(QPageSize::PageSizeId);
	...
	QPageSize::PageSizeId m_paper_format;
	QPageLayout::Orientation m_paper_orientaion;
...
public slots:
	...
	void set_paper_format(QPageSize::PageSizeId);
